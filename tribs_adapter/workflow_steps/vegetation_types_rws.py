...
class VegetationTypesRWS(SpatialResourceWorkflowStep):
    """
    Workflow step used for visualizing the layer of vegetation types and group vegetation types.
    ...
    """  # noqa: #501
    CONTROLLER = 'tethysapp.tribs.controllers.workflow_steps.vegetation_types_mwv.VegetationTypesMWV'
    TYPE = 'vegetation_types_workflow_step'
    ...
    def init_parameters(self, *args, **kwargs):
        ...
        return {
            'categories': {
                'help': 'Vegetation groups selected by the user.',
                'value': None,
                'required': True,
                'is_tabular': True
            },
